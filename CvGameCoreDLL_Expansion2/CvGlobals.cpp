...
CvGlobals::CvGlobals() :
	...
	GD_INT_INIT(HISTORY_LOCAL_NUM_BEST_CITIES, 4),
	...
	GD_INT_INIT(BALANCE_UNHAPPY_CITY_BASE_VALUE_BOREDOM, 100),
	GD_INT_INIT(BALANCE_UNHAPPY_CITY_BASE_VALUE_ILLITERACY, 100),
	GD_INT_INIT(BALANCE_UNHAPPY_CITY_BASE_VALUE_DISTRESS, 100),
	GD_INT_INIT(BALANCE_UNHAPPY_CITY_BASE_VALUE_POVERTY, 100),
	...
	GD_INT_INIT(UNHAPPINESS_MEDIANS_MIN_POP_REQUIREMENT, 3),
...
void CvGlobals::cacheGlobals()
{
	...
	GD_INT_CACHE(BALANCE_UNHAPPY_CITY_BASE_VALUE_DISTRESS);
	...
	GD_INT_CACHE(UNHAPPINESS_MEDIANS_MIN_POP_REQUIREMENT);
